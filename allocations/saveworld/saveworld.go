...
func saveworld(agents []*model.Agent, items []*model.Item) (map[string][]string, error) {
...
// else bad thing...
func SaveWorld(goods []string, agent1Name string, valuation1 map[string]int, agent2Name string, valuation2 map[string]int) (allocation map[string][]string, err error) {
	...
	allocation, err = saveworld(agents, items)
